...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/grievance/web/user_login.php', 
		...
		.success(function(data, status, headers, config) 
		{
			...
			else if(data.success == 6) // College Head Login 
			{
				alert("Login Successful");
				$cookieStore.put("cook_user_mail",data.email);
				$cookieStore.put("cook_user_mob",data.mobile);
				...
				$cookieStore.put("cook_user_site",data.field_6);
				$cookieStore.put("cook_user_area",data.field_7);
				window.location = "college_all_home.html";  // Home Page
				return;				
			}
			else if(data.success == 7) // College Head Login 
			{
				alert("Login Successful");
				$cookieStore.put("cook_user_mail",data.email);
				$cookieStore.put("cook_user_mob",data.mobile);
				...
				$cookieStore.put("cook_user_site",data.field_6);
				$cookieStore.put("cook_user_area",data.field_7);
				window.location = "hostel_home.html";  // Home Page
				return;				
			}
			else if(data.success == 8) // College Head Login 
			{
				alert("Login Successful");
				$cookieStore.put("cook_user_mail",data.email);
				$cookieStore.put("cook_user_mob",data.mobile);
				...
				$cookieStore.put("cook_user_site",data.field_6);
				$cookieStore.put("cook_user_area",data.field_7);
				window.location = "food_home.html";  // Home Page
				return;				
			}
			else if(data.success == 9) // Certificate Head Login 
			{
				alert("Login Successful");
				$cookieStore.put("cook_user_mail",data.email);
				$cookieStore.put("cook_user_mob",data.mobile);
				...
				$cookieStore.put("cook_user_site",data.field_6);
				$cookieStore.put("cook_user_area",data.field_7);
				window.location = "certificate_home.html";  // Home Page
				return;				
			}
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/grievance/web/admin_login.php', 
			{'email': $scope.email, 'password':$scope.password})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
...
//************************** admin_register **********************************/	
	...
	{		
		$http.post('http://10.0.2.2/projects/grievance/web/admin_register.php',{
...
/************************** Update User Info **********************************/
		...
		$http.post('http://10.0.2.2/projects/grievance/web/get_user_info.php',
		{
	...
	{		
		$http.post('http://10.0.2.2/projects/grievance/web/admin_update.php',{
		 'name':$scope.name,'email':$scope.email,
		 'password':$scope.password,'mobile': $scope.mobile})
		.success(function(data, status, headers, config) 
		{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/grievance/web/newpassword.php', 
			{	'email': $scope.email, 'password':$scope.password,
