...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/grievance/web/update_status.php',{
		 'email':email
		 })
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/grievance/web/create_employee.php', 
		{
	...
	{
	$http.post('http://10.0.2.2/projects/grievance/web/user_register.php', 
		{
		'name':$scope.name1,'email':$scope.email,'password':$scope.password,
		'mobile':$scope.mobile,'field_1':$scope.field_1,'field_2':$scope.field_2,
		'field_3':$scope.field_3,'field_4':$scope.field_4,
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_employee_info.php', 
		{
...
$scope.save_employee = function() 
	{
	$http.post('http://10.0.2.2/projects/grievance/web/save_employee.php', {
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/grievance/web/create_category.php', 
		{
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/grievance/web/create_dept.php', 
		{
		'field_1':$scope.field_1
		})
		.success(function(data, status, headers, config) 
...
$scope.save_dept = function() 
	{
	$http.post('http://10.0.2.2/projects/grievance/web/save_dept.php', {
...
$scope.save_cat = function() 
	{
	$http.post('http://10.0.2.2/projects/grievance/web/save_cat.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/grievance/web/create_site.php', 
		{
		'field_1':$scope.field_1
		})
		.success(function(data, status, headers, config) 
...
$scope.save_site = function() 
	{
	$http.post('http://10.0.2.2/projects/grievance/web/save_site.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/grievance/web/create_area.php', 
		{
...
$scope.save_area = function() 
	{
	$http.post('http://10.0.2.2/projects/grievance/web/save_area.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
$scope.get_site_area = function(field_6) 
	{
	$http.post('http://10.0.2.2/projects/grievance/web/get_site_area.php', {
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/grievance/web/create_user.php', 
		{
		'field_1':$scope.field_1
		})
		.success(function(data, status, headers, config) 
...
$scope.save_user = function() 
	{
	$http.post('http://10.0.2.2/projects/grievance/web/save_user.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/grievance/web/delete_hirarchy.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/grievance/web/delete_tat.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/grievance/web/delete_question.php', 
		{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/grievance/web/delete_dept.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
	...
	{		
        $http.post('http://10.0.2.2/projects/grievance/web/delete_cat.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/grievance/web/delete_area.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/grievance/web/delete_site.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/grievance/web/application_get_admin.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/grievance/web/update_tat_grievance.php')
		.success(function(data, status, headers, config) 
		{
				$scope.update_tat_details = data.details;
		});

	$http.post('http://10.0.2.2/projects/grievance/web/get_tat.php')
	.success(function(data, status, headers, config) 
	{
		$scope.tat_details = data.details;
    });
	
	$http.post('http://10.0.2.2/projects/grievance/web/get_employee.php')
	.success(function(data, status, headers, config) 
	{
		$scope.emp_details = data.details;
    });
	
	$http.post('http://10.0.2.2/projects/grievance/web/get_date.php')
	.success(function(data, status, headers, config) 
	{
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_dept.php')
	.success(function(data, status, headers, config) 
	{
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_category.php')
	.success(function(data, status, headers, config) 
	{
			$scope.category_details = data.details;
	});
	
	$http.post('http://10.0.2.2/projects/grievance/web/get_hirarchy.php')
	.success(function(data, status, headers, config) 
	{
			$scope.hirarchy_details = data.details;
	});
	
	$http.post('http://10.0.2.2/projects/grievance/web/get_site.php')
	.success(function(data, status, headers, config) 
	{
			$scope.site_details = data.details;
	});
	
	$http.post('http://10.0.2.2/projects/grievance/web/get_area.php')
	.success(function(data, status, headers, config) 
	{
			$scope.area_details = data.details;
	});
	
	$http.post('http://10.0.2.2/projects/grievance/web/get_user_type.php')
	.success(function(data, status, headers, config) 
	{
			$scope.user_type_details = data.details;
	});
	
	$http.post('http://10.0.2.2/projects/grievance/web/get_site_results.php')
	.success(function(data, status, headers, config) 
	{
			$scope.all_site_results = data.details;
	});
	
	$http.post('http://10.0.2.2/projects/grievance/web/get_search_results.php')
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/grievance/web/user_get_all.php')
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/grievance/web/create_tat.php', 
		{
		'field_1':$scope.field_1,'field_2':$scope.field_2,
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/grievance/web/create_hirarchy.php', 
		{
		'field_1':$scope.field_1,'field_2':$scope.field_2,
	...
	{		
		$http.post('http://10.0.2.2/projects/grievance/web/save_hirarchy.php',{
...
/****************************************************************************/	
	...
	{		
		$http.post('http://10.0.2.2/projects/grievance/web/save_tat.php',{
...
/****************************************************************************/
		...
		$http.post('http://10.0.2.2/projects/grievance/web/get_admin_info.php',
		{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/grievance/web/admin_update_info.php',{
...
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/grievance/web/get_all_results.php')
		.success(function(data, status, headers, config) 
		{
