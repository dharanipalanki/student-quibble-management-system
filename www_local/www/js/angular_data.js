...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_user_ticket_last.php', 
		{
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_user_grievance.php', 
		{
		'id':$scope.cook_user_email
		})
		.success(function(data, status, headers, config) 
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_user_redressal.php', 
		{
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_hostel_redressal.php', 
		{
		'id':$scope.cook_user_type,'dept':$scope.cook_user_dept
		})
		.success(function(data, status, headers, config) 
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_food_redressal.php', 
		{
		'id':$scope.cook_user_type,'dept':$scope.cook_user_dept
		})
		.success(function(data, status, headers, config) 
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_all_college_redressal.php', 
		{
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_all_redressal.php')
		.success(function(data, status, headers, config) 
		{
			$scope.all_redressal_details = data.details;
        });
		
	$http.post('http://10.0.2.2/projects/grievance/web/get_forward.php',{
...
$scope.get_file_data = function() 
	{
 $http.get('http://10.0.2.2/projects/grievance/web/upload.php')
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
			{
...
/****************************************************************************/
	...
	{
		$http.post('http://10.0.2.2/projects/grievance/web/create_grievance.php', 
		{
...
/****************************************************************************/
	...
	{
		$http.post('http://10.0.2.2/projects/grievance/web/read_notification.php', 
		{
...
$scope.user_update_info = function(name,password,mobile) 
	...
	{		
		$http.post('http://10.0.2.2/projects/grievance/web/user_update_info.php',{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/grievance/web/save_rating.php',{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/grievance/web/update_grievance.php',{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/grievance/web/delay_grievance.php',{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/grievance/web/forward_grievance.php',{
