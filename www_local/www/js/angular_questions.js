...
$http.post('http://10.0.2.2/projects/grievance/web/get_site.php')
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_survey.php')
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/grievance/web/sum_get.php', {
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_comment.php', {
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_choice.php', {
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_yesno.php', {
			'email': $scope.cook_email,'field_3': $scope.cook_field_3})
		.success(function(data, status, headers, config) 
		{
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/grievance/web/get_ratecomment.php', {
			'email': $scope.cook_email,'field_3': $scope.cook_field_3})
		.success(function(data, status, headers, config) 
		{
